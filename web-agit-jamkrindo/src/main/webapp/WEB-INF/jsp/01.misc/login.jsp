        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <div class="login100-form-title" style="background-image: url(${pageContext.request.contextPath}/assets/login/images/logo.jpg);">
                    </div>

                    <form class="login100-form validate-form" method="post" role="form" data-toggle="validator" action="${pageContext.request.contextPath}/j_spring_security_check">
                        <c:if test="${param.error}">
                            <div class="alert-danger" style="font-size: 12px;">
                                <span>
                        ...
                        <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
                            ...
                            <input class="input100" type="password" name="j_password" placeholder="Enter password">
                            <span class="focus-input100"></span>
                        </div>
