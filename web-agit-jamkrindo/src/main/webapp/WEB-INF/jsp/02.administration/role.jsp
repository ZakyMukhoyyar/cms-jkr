                    ...
                    "aoColumnDefs": [
                        {
                            ...
                            "mRender": function (data, type, row) {
                                return '<a href="${pageContext.request.contextPath}/administration/role/edit/' + row.id + '"><span class="btn btn-danger btn-sm" type="button"><i class="fa fa-pencil-square-o"></i>Edit</span></a>';
                            },
                            "aTargets": [2]
                        }
                    ]
                ...
                <div class="col-lg-4 ">
                    <div class="main-header">
                        <ul class="breadcrumb">
                            ...
                            <li>Administrator</li>
                            <li class="active"><a href="${pageContext.request.contextPath}/administration/role/">Roles</a></li>
                        </ul>
                        <h3><i class="fa fa-sitemap"></i> Roles   </h3><em>Administration</em>
                    </div>
                </div>
                <div class="col-lg-8 ">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" id="searchRoleName" class="form-control" placeholder="Role Name">
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="form-group">
