                ...
                <div class="col-lg-4 ">
                    <div class="main-header">
                        <ul class="breadcrumb">
                            ...
                            <li>Administrator</li>
                            <li class="active"><a href="${pageContext.request.contextPath}/administration/menu/">Menu</a></li>
                        </ul>
            ...
            <div class="main-content">
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3 style="
                            color: white;"><i class="fa fa-table"></i> List of Menu</h3>
                    </div>
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" id="searchMenuName" class="form-control" placeholder="Menu Name">
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="form-group">
